...
export function TransactionForm({ accounts, initialType = "credit" }: TransactionFormProps) {
  ...
  function handleAutoSplitWithAccount(virtualAccountId: number) {
    ...
    setError(null);
    setVirtualAllocations(buildAutoSplitAllocations(selectedAcc, virtualAccounts, numAmount, type));
  }
  ...
  function handleAddCustomAllocation() {
    ...
    setVirtualAllocations(addAllocationRow(virtualAllocations, defaultAcc.id, numAmount, type));
  }

  function handleRemoveAllocation(index: number) {
    setVirtualAllocations(removeAllocationRow(virtualAllocations, index));
  }
  ...
  function handleUpdateAllocation(
    ...
    setVirtualAllocations(updateAllocationRow(virtualAllocations, index, field, value));
  }
